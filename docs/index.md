...
- [Schema introspection](schema-introspection.md) - what BIDS declares for a kind of file, before one exists: the API a metadata form or conversion template needs.
